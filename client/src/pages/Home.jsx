...
import { Upload, FileText, ArrowRight, CheckCircle, Shield, Clock, DollarSign, FileCheck, Star } from 'lucide-react';
        ...
        <section className="relative pt-10 pb-20 lg:pt-20 lg:pb-28 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tight mb-6 leading-tight max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
              Anule sua Multa de Trânsito com <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Inteligência Artificial</span>
            </h1>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
              Não gaste R$ 300,00 com advogados. Nossa IA analisa seu caso gratuitamente e gera um <strong>recurso jurídico completo</strong>, fundamentado na lei, <strong>pronto para assinar e protocolar</strong>.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
              <Link to="/upload" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white text-lg font-bold py-4 px-8 rounded-xl shadow-xl shadow-blue-200 transition-all active:scale-95 flex items-center justify-center gap-2">
                <Upload size={24} />
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-x-8 gap-y-4 text-sm font-medium text-gray-500 animate-in fade-in duration-1000 delay-500">
              <div className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Baseado no CTB e CONTRAN</div>
              <div className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Análise de Viabilidade Imediata</div>
              <div className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Documento em PDF Profissional</div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Simplificamos a burocracia. Em poucos minutos você terá em mãos a defesa perfeita para o seu caso.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden">
              ...
              <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 mb-6 font-bold text-2xl">1</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Envie a Notificação</h3>
              <p className="text-gray-500 leading-relaxed">
                Tire uma foto da multa ou digite os dados manualmente. Nossa tecnologia OCR lê as informações instantaneamente.
              </p>
            </div>

            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden">
              <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-indigo-50 rounded-full opacity-50 blur-2xl"></div>
              <div className="w-14 h-14 bg-indigo-100 rounded-2xl flex items-center justify-center text-indigo-600 mb-6 font-bold text-2xl">2</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">IA Analisa o Caso</h3>
              <p className="text-gray-500 leading-relaxed">
                O algoritmo verifica erros formais e busca as melhores teses jurídicas na legislação para anular sua infração.
              </p>
            </div>

            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden">
              <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-green-50 rounded-full opacity-50 blur-2xl"></div>
              <div className="w-14 h-14 bg-green-100 rounded-2xl flex items-center justify-center text-green-600 mb-6 font-bold text-2xl">3</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Baixe e Protocole</h3>
              <p className="text-gray-500 leading-relaxed">
                Receba o <strong>documento completo em PDF</strong>. Basta imprimir, assinar e enviar ao órgão autuador.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                Democratizamos o acesso à defesa de trânsito de qualidade. Compare e veja a diferença.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white text-gray-900 rounded-3xl p-8 border-4 border-blue-500 shadow-2xl relative transform lg:scale-110">
                ...
                <Link to="/upload" className="mt-8 w-full block bg-gray-900 hover:bg-gray-800 text-white text-center font-bold py-4 rounded-xl transition-all">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <h3 className="font-bold text-lg text-gray-900 mb-2">O documento serve para qualquer estado?</h3>
              <p className="text-gray-600">Sim. A legislação de trânsito (CTB) é federal. Nossa IA gera o recurso endereçado corretamente para o órgão autuador de qualquer estado do Brasil.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <h3 className="font-bold text-lg text-gray-900 mb-2">Preciso contratar advogado depois?</h3>
              <p className="text-gray-600">Não. O recurso administrativo não exige advogado. O documento que geramos já vem com a fundamentação legal e técnica necessária. É só assinar e entregar.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <h3 className="font-bold text-lg text-gray-900 mb-2">E se eu não souber o Artigo da infração?</h3>
              <p className="text-gray-600">Fique tranquilo. Ao fazer o upload da foto da notificação, nossa IA identifica automaticamente o artigo, a descrição e os detalhes para montar a defesa.</p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center px-4">
          <div className="inline-block p-1 rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 shadow-2xl">
            <div className="bg-white rounded-[1.3rem] px-8 py-12 md:px-16 md:py-16 max-w-4xl">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Não deixe os pontos vencerem</h2>
              <p className="text-gray-600 text-lg mb-8 max-w-xl mx-auto">
                Comece agora mesmo. A análise inicial de viabilidade é <strong>100% gratuita</strong>.
              </p>
              <Link to="/upload" className="inline-flex items-center justify-center gap-2 bg-gray-900 text-white font-bold text-xl py-4 px-10 rounded-xl hover:bg-gray-800 transition-all hover:scale-105 shadow-lg">
                Iniciar Defesa Grátis <ArrowRight size={20} />
              </Link>
            </div>
          </div>
        </div>
