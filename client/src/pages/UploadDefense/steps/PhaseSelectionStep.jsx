		...
		<div className="max-w-4xl mx-4 md:mx-auto py-10">
			<header className="mb-4 md:mb-12 text-center">
				...
				<p className="text-gray-600">
					A IA não conseguiu identificar a fase automaticamente ou você optou por alterar. Para
					melhor qualidade do recurso, preencha os dados manualmente.
				</p>
				<p className="text-gray-600 mt-3">
					<strong>Para melhor qualidade do recurso, preencha os dados manualmente.</strong>
				</p>
			</header>
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
				<button
					...
					<h3 className="font-bold text-xl text-gray-800 mb-2">Defesa Prévia</h3>
				...
				<button
					...
					<h3 className="font-bold text-xl text-gray-800 mb-2">Recurso JARI</h3>
					<p className="text-md text-gray-600 leading-relaxed">
				...
				<button
					...
					<h3 className="font-bold text-xl text-gray-800 mb-2">CETRAN</h3>
					<p className="text-md text-gray-600 leading-relaxed">
