					...
					<div className="w-full flex justify-center px-4">
						<div className="w-full flex justify-center">
							<button
								...
								className="w-full md:w-2/3 text-center text-gray-600 text-sm md:text-md mt-8 hover:text-blue-600 hover:bg-blue-50/50 transition-all border border-gray-200 hover:border-blue-200 rounded-xl py-3 flex items-center justify-center gap-2 font-medium">
								<ArrowLeft size={18} /> Voltar e editar dados da infração
							</button>
						</div>
					</div>
				</div>
