					...
					<div className="prose prose-blue max-w-none text-gray-600 space-y-8">
						<section>
							<h3 className="text-xl font-bold text-gray-900 flex items-center gap-2 mb-4">
								<span className="bg-blue-600 text-white w-7 h-7 rounded-full flex items-center justify-center text-xs shrink-0 font-bold">1</span>
								Aceitação dos Termos
							</h3>
							<p className="leading-relaxed">
								Ao acessar e utilizar a plataforma <strong>Auto Defesa</strong> ("Plataforma"), você ("Usuário") concorda integralmente com estes Termos de Uso. Se você não concordar com qualquer disposição destes termos, não deverá utilizar nossos serviços.
							</p>
						</section>

						<section>
							<h3 className="text-xl font-bold text-gray-900 flex items-center gap-2 mb-4">
								<span className="bg-blue-600 text-white w-7 h-7 rounded-full flex items-center justify-center text-xs shrink-0 font-bold">2</span>
								Descrição do Serviço
							</h3>
							<p className="leading-relaxed">
								O Auto Defesa oferece um serviço de análise técnica e administrativa de multas de trânsito, utilizando tecnologia de inteligência artificial e OCR (reconhecimento óptico de caracteres) para:
							</p>
							<ul className="list-disc pl-5 space-y-2 mt-2">
								<li>Extrair dados de autos de infração e notificações.</li>
								<li>Identificar possíveis nulidades formais e materiais com base na legislação vigente.</li>
								<li>Gerar minutas de recursos administrativos (Defesa Prévia, JARI, CETRAN).</li>
							</ul>
							<p className="mt-4 leading-relaxed">
								Nossas análises são fundamentadas no Código de Trânsito Brasileiro (CTB), Manual Brasileiro de Fiscalização de Trânsito (MBFT) e Resoluções do CONTRAN.
							</p>
						</section>
						...
						<section className="bg-blue-50/50 p-6 md:p-8 rounded-2xl border border-blue-100">
							...
							<ul className="space-y-4">
								<li className="flex gap-3">
									...
									<p><strong>Não somos um escritório de advocacia:</strong> O serviço realiza auditoria técnica e documental, fornecendo um documento base (minuta). <strong>NÃO</strong> prestamos consultoria jurídica personalizada.</p>
								</li>
								<li className="flex gap-3">
									<div className="text-blue-600 mt-1 font-bold">•</div>
									<p><strong>Obrigação de Meio:</strong> A elaboração do recurso constitui uma obrigação de meio, e não de fim. O Auto Defesa utiliza as melhores teses disponíveis, mas <strong>NÃO garantimos o deferimento (vitória)</strong> do recurso, pois a decisão final cabe exclusivamente às autoridades de trânsito.</p>
								</li>
								<li className="flex gap-3">
									<div className="text-blue-600 mt-1 font-bold">•</div>
									<p><strong>Responsabilidade do Protocolo:</strong> Cabe exclusivamente ao Usuário a responsabilidade pela revisão, assinatura, impressão e protocolo (envio) do recurso gerado junto ao órgão competente, dentro do prazo legal.</p>
								</li>
							</ul>
						</section>
						...
						<section>
							<h3 className="text-xl font-bold text-gray-900 flex items-center gap-2 mb-4">
								<span className="bg-blue-600 text-white w-7 h-7 rounded-full flex items-center justify-center text-xs shrink-0 font-bold">4</span>
								Responsabilidades do Usuário
							</h3>
							<p className="mb-4">Ao utilizar a Plataforma, o Usuário declara e se compromete a:</p>
							<ul className="list-disc pl-5 space-y-2">
								<li>Fornecer informações verdadeiras, completas e atualizadas.</li>
								<li>Enviar apenas documentos e autos de infração de sua propriedade ou para os quais possua autorização legal.</li>
						...
						<section>
							...
							<ul className="list-disc pl-5 space-y-2">
								...
								<li><strong>Política de Reembolso:</strong> Devido à natureza digital e instantânea do serviço (entrega do documento gerado pela IA), os valores <strong>não são reembolsáveis</strong> após a utilização do crédito e download da peça, configurando a efetiva prestação do serviço.</li>
								<li>Em caso de falha técnica comprovada do nosso sistema que impeça a geração do documento, o crédito será restituído à conta do Usuário.</li>
							</ul>
						</section>
						...
						<section>
							...
							<ul className="list-disc pl-5 space-y-2">
								...
								<li>Danos indiretos, lucros cessantes ou perda de oportunidades decorrentes do uso da plataforma.</li>
								<li>Indisponibilidade temporária do sistema por motivos de força maior ou manutenção de servidores parceiros (OpenAI/Google).</li>
							</ul>
						</section>
						...
						<section className="pt-8 border-t border-gray-100">
							...
							<p className="mb-2">
								<strong>E-mail:</strong> <a className="text-blue-600 font-bold hover:underline" href="mailto:contato@meuautodefesa.com.br">contato@meuautodefesa.com.br</a>
							</p>
							<p>
								Ou utilize nosso <Link to="/help" className="text-blue-600 font-bold hover:underline">formulário de atendimento</Link>.
							</p>
						</section>

						<div className="mt-12 bg-gray-50 p-8 rounded-2xl text-center border border-gray-100 shadow-inner">
							<p className="text-sm font-medium text-gray-500 italic">
								Ao clicar em "Aceitar", "Cadastrar" ou ao gerar seu primeiro recurso, você concorda formalmente com todas as cláusulas acima.
							</p>
						</div>
					</div>
				</div>
