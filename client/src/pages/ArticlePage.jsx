    ...
    return (
      <MainLayout>
        <div className="max-w-7xl mx-auto px-4 py-32 text-center">
          ...
          <Link to="/guia" className="text-blue-600 hover:underline">Voltar para o Guia</Link>
        </div>
      </MainLayout>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <main className="lg:col-span-8">
            ...
            <div className="mt-12 pt-12 border-t border-gray-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Você também pode se interessar por:</h3>
            ...
            <div className="mt-12 pt-12 border-t border-gray-100">
              ...
              <div className="space-y-4">
                {article.faq && article.faq.map((item, idx) => (
            ...
            <div className="mt-16 bg-blue-600 rounded-2xl p-8 md:p-12 text-center shadow-xl shadow-blue-200">
              ...
              <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
                Nossa IA já analisou milhares de casos como o seu. Gere uma defesa técnica personalizada em minutos.
              </p>
              <Link 
                to="/upload" 
            ...
            <div className="sticky top-24">
              ...
              <div className="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <nav className="flex flex-col gap-2">
                  <Link to="/artigo/lei-seca" className="text-sm text-gray-600 hover:text-blue-600 py-1 transition-colors border-b border-gray-200 border-dashed pb-1">
                    Lei Seca
                  </Link>
                  <Link to="/artigo/excesso-velocidade" className="text-sm text-gray-600 hover:text-blue-600 py-1 transition-colors border-b border-gray-200 border-dashed pb-1">
                    Excesso de Velocidade
                  </Link>
                  <Link to="/artigo/cnh-vencida" className="text-sm text-gray-600 hover:text-blue-600 py-1 transition-colors">
                    CNH Vencida
                  </Link>
                </nav>
              </div>
